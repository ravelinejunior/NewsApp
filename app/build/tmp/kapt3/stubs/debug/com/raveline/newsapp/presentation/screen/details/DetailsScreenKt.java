...
public final class DetailsScreenKt {
    ...
    com.raveline.newsapp.domain.model.ArticleModel article, @org.jetbrains.annotations.NotNull
    kotlin.jvm.functions.Function1<? super com.raveline.newsapp.presentation.screen.details.components.DetailsEvent, kotlin.Unit> event, @org.jetbrains.annotations.NotNull
    kotlin.jvm.functions.Function0<kotlin.Unit> navigateUp) {
    }
    
    @androidx.annotation.RequiresApi(value = android.os.Build.VERSION_CODES.O)
    @androidx.compose.ui.tooling.preview.Preview(showBackground = true, showSystemUi = true)
    @androidx.compose.ui.tooling.preview.Preview(showBackground = true, showSystemUi = true, uiMode = android.content.res.Configuration.UI_MODE_NIGHT_YES)
    @androidx.compose.runtime.Composable
    public static final void DetailsScreenPreview() {
    }
}