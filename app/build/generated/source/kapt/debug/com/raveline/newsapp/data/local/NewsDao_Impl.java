...
public final class NewsDao_Impl implements NewsDao {
  ...
  public NewsDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfArticleModel = new EntityInsertionAdapter<ArticleModel>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `ARTICLES_TABLE` (`id`,`source`,`author`,`title`,`description`,`url`,`urlToImage`,`publishedAt`,`content`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?)";
      }
  ...
  public Flow<List<ArticleModel>> getAllStoredNews() {
    final String _sql = "SELECT * FROM ARTICLES_TABLE";
      ...
      public List<ArticleModel> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new ArticleModel(_tmpId,_tmpSource,_tmpAuthor,_tmpTitle,_tmpDescription,_tmpUrl,_tmpUrlToImage,_tmpPublishedAt,_tmpContent);
            _result.add(_item);
          }
          return _result;
        } finally {
