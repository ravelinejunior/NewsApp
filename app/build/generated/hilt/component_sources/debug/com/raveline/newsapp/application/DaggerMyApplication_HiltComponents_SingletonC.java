...
import com.raveline.newsapp.di.DatabaseModule_ProvideNewsDaoFactory;
import com.raveline.newsapp.di.DatabaseModule_ProvideNewsDatabaseFactory;
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 4: // com.raveline.newsapp.data.local.NewsDao 
          return (T) DatabaseModule_ProvideNewsDaoFactory.provideNewsDao(singletonCImpl.provideNewsDatabaseProvider.get());

          case 5: // com.raveline.newsapp.data.local.NewsDatabase 
          return (T) DatabaseModule_ProvideNewsDatabaseFactory.provideNewsDatabase(ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule));

          case 6: // com.raveline.newsapp.domain.use_cases.app_entry.AppEntryUseCasesModel 
          ...
          case 7: // com.raveline.newsapp.domain.manager.LocalUserManager 
