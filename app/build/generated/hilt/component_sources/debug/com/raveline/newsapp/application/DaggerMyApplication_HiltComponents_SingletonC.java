package com.raveline.newsapp.application;
...
import com.raveline.newsapp.MainActivity;
import com.raveline.newsapp.data.remote.services.NewsApi;
import com.raveline.newsapp.di.AppModule;
import com.raveline.newsapp.di.AppModule_ProvideGetNewsUseCaseFactory;
import com.raveline.newsapp.di.AppModule_ProvideNewsRepositoryFactory;
import com.raveline.newsapp.di.AppModule_ProvidesAppEntryUseCaseFactory;
import com.raveline.newsapp.di.AppModule_ProvidesLocalUserManagerFactory;
import com.raveline.newsapp.di.NetworkModule;
import com.raveline.newsapp.di.NetworkModule_ProvideHttpClientFactory;
import com.raveline.newsapp.di.NetworkModule_ProvideRetrofitInstanceFactory;
...
import com.raveline.newsapp.presentation.viewmodel.MainViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(3).put("com.raveline.newsapp.presentation.screen.home.HomeViewModel", ((Provider) homeViewModelProvider)).put("com.raveline.newsapp.presentation.viewmodel.MainViewModel", ((Provider) mainViewModelProvider)).put("com.raveline.newsapp.presentation.screen.onboarding.OnBoardingViewModel", ((Provider) onBoardingViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.raveline.newsapp.presentation.screen.home.HomeViewModel 
  ...
  private static final class SingletonCImpl extends MyApplication_HiltComponents.SingletonC {
    ...
    private Provider<LocalUserManager> providesLocalUserManagerProvider;

    private Provider<AppEntryUseCasesModel> providesAppEntryUseCaseProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.providesLocalUserManagerProvider = DoubleCheck.provider(new SwitchingProvider<LocalUserManager>(singletonCImpl, 5));
      this.providesAppEntryUseCaseProvider = DoubleCheck.provider(new SwitchingProvider<AppEntryUseCasesModel>(singletonCImpl, 4));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 4: // com.raveline.newsapp.domain.use_cases.app_entry.AppEntryUseCasesModel 
          return (T) AppModule_ProvidesAppEntryUseCaseFactory.providesAppEntryUseCase(singletonCImpl.providesLocalUserManagerProvider.get());

          case 5: // com.raveline.newsapp.domain.manager.LocalUserManager 
          return (T) AppModule_ProvidesLocalUserManagerFactory.providesLocalUserManager(ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule));
